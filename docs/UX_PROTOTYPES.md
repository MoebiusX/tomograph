# UX Prototypes — superseded

The three divergent prototypes (`?proto=a|b|c`) built for
[UX_REDESIGN_BRIEF.md](UX_REDESIGN_BRIEF.md) served their purpose and
were retired on 2026-06-11: the maintainer's call was that a menu of
options doesn't take load off — one converged, finished UI does.
...
git history on `codex/ux-prototypes` if ever needed.
