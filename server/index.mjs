...
import {
  ...
  readDeploySnapshot, workspaceInfo,
} from './workspace.mjs';
import {
...
// Deploy constants and the write path's shaping transforms live in
// server/deploy-helpers.mjs (unit-tested in server/test-deploy-helpers.mjs).
// Grafana 12/13 is the only deploy product for now; OTel Collector +
// standalone Alertmanager remain download-only.
